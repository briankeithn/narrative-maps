...
# Initialize spacy.
nlp = spacy.load("en_core_web_md") # We could use a different model.
...
color_cluster = ["blue","red", "orange", "purple", "yellow", "green"]
color_id = ["#a6cee3", "#fb9a99", "#fdbf6f", "#cab2d6", "#ffff99"]
